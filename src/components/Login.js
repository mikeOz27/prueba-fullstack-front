...
import { Container, Card, CardContent, Typography, TextField, Checkbox, Button, Box } from '@mui/material';
...
const Login = ({ setToken, setUser }) => {
	...
	return (
        <Container fluid className="p-4" sx={{ background: 'radial-gradient(circle, rgba(218, 81%, 95%) 0%, rgba(218, 81%, 75%) 100%)', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh' }}>
              <Card sx={{ width: '100%', maxWidth: 400, bgcolor: 'rgba(255, 255, 255, 0.9)', boxShadow: 3 }}>
                <CardContent sx={{ padding: 5 }}>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <Button type="submit" fullWidth variant="contained" color="primary" sx={{ padding: '10px' }}>
                      Login
                    </Button>
                  </form>
                </CardContent>
